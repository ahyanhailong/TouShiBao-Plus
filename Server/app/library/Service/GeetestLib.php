...
class GeetestLib
{
    ...
    //jimmy注册的默认 ID和KEY,可以在配置文件中配置新的私钥
    const CAPTCHA_ID = '6f7dd83970a322f48e9e65aa9ad95dad';
    const PRIVATE_KEY = 'fdbbf23e51af1fa69a2f6fbf3b65c8ee';
    ...
    public function __construct($captcha_id = self::CAPTCHA_ID, $private_key = self::PRIVATE_KEY)
    {
        $this->captcha_id = self::CAPTCHA_ID;
