MyApp.service('abnormalService',['$http','httpService',function ($http,httpService) {
    ...
    //详情 单元素请求错误详情
    this.get_single_element_exception  = env_config.API.Error.GET_SINGLE_ELEMENT_EXCEPTION
    ...
    this.abnormalDetail = function (dataSource) {
        var URL = self.get_single_element_exception
