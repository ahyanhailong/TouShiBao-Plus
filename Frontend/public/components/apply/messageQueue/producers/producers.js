MyApp.controller('producers', [
    '$scope', '$rootScope', 'producersService',
    function ($scope, $rootScope, service) {
        $rootScope.tabStatus = 'producers';

        $scope.$emit('startMessageQueue', 'producer');
...
MyApp.service('producersService', ['httpService', function (http) {
    var listApi = env_config.API.AppMessageQueue.GET_CONSUMER_LIST;
