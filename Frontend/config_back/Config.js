    ...
    return {
        ...
        API: {
            ...
            LognIAndRegister:{
                ...
                //滑块验证
                GEE_INIT : HOST_ADDRESS + '/register/auth/geeinit',
                //用户重置邮箱发送邮件
            ...
            BusinessAnalysis: {//事务分析API
                ...
                // 响应时间和请求数-弹窗
                GET_OVERVIEW_TRANSACTION_POP_LIST: HOST_ADDRESS + '/application/transaction_analysis/get_overview_transaction_pop_list',
                //请求数按响应时间分布
