...
(function (exports, module, define) {
    ...
    v.extend(validate, {
        ...
        isURL: function (value) {
            ...
            //value.replace(/(^\s*)|(\s*$)/g, " ");//去除左右两边空格
            return re.test(value.replace(/(^\s*)|(\s*$)/g, ""));
        },
    ...
    validate.validators = {
        ...
        domain: v.extend(function (value, options) {
            options = v.extend({}, this.options, options);
            var message = options.message || this.message || "is not a valid domain";
            value=value.replace(/(^\s*)|(\s*$)/g, "");
            // Empty values are fine
            if (!v.isDefined(value)) {
                return;
