...
class InflectorHelper
{
     ...
     * For detailed information see [unicode normalization
     * forms](http://unicode.org/reports/tr15/#Normalization_Forms_Table)
     *
     ...
     * @param bool|string $strict    whether to insert a separator between two consecutive uppercase chars, defaults to
     *                               false
     *
